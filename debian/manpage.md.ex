% hashfile(SECTION) | User Commands
%
% "March 17 2023"
...
hashfile - program to do something

# SYNOPSIS

**hashfile** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**hashfile** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **hashfile** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**hashfile** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    hashfile. See **foo.conf**(5) for further details.
...
**hashfile** provides some return codes, that can be used in scripts:
...
JuanMartin <juanmartin@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 JuanMartin
